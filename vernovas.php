...
$result = mysqli_query($mysqli, "SELECT * FROM mensagens where nova = 'S' ");
?>
...
<body>
	<a href="Mensagem.html">Voltar Para o Envio De Mensagens</a> | <a href="vertodas.php">Ver Todas as Mensagens</a> 
	<br><br>
